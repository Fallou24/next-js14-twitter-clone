...
export default function PostContent({post,isAlreadyLiked}:{post:any,isAlreadyLiked:boolean}) {
  ...
  return (
    <article
    onClick={() => router.push(post.username + "/posts/" + post.id)}
  ...
  >
    ...
    <div className="w-full">
      ...
      <PostActions isAlreadyLiked={isAlreadyLiked} likes={likes} comments={comment} postId={id} />
    </div>
  </article>
  )
}
